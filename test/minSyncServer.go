...
// -----END PRIVATE KEY-----`
	...
	instance := serverInstance.New("/Users/luickklippel/Documents/projekte/go/src/goMinSync/test/temp", 1000000, "test", "127.0.0.1", 8000, 8001, "", "", errorStream)

	instance.StartInstance(errorStream)

	// instance := serverInstance.New("/Users/luickklippel/Documents/projekte/go/src/goMinSync/test/temp", 1000000, "test", "127.0.0.1", 8000, 8001, cert, key)
